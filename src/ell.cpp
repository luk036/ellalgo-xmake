 ...
 * @param[in] x
 */
Ell::Ell(double alpha, Arr1 xc) : Ell{alpha, xt::eye(xc.size()), std::move(xc)} {}
 ...
 * @return (i32, double)
 */
auto Ell::update_parallel(const Arr1& grad, const std::pair<double, std::optional<double>>& beta)
